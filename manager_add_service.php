                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <select name="employee_id[]" multiple class="form-control" required>
                                <?php if ($employee_result->num_rows > 0): ?>
                                    <?php while($employees = $employee_result->fetch_assoc()): ?>
                                        <option value="<?= $employees['id']; ?>"><?= htmlspecialchars($employees['name']); ?></option>
                                    <?php endwhile; ?>
                                <?php else: ?>
